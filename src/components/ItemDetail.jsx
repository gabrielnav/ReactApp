...
import ItemCount from './ItemCount';
 ...
 const ItemDetail = ( {prod} ) => {
    ...
    return (
        <div>
            <Link to="/productos" className="pt-2 pl-2 my-2 flex items-center">
            ...
            <div className="item-detail-container h-screen" key={`${prod.id}`}> 
                <img src={`${prod.pictureUrl}`} className="rounded mb-8 pt-4 shadow-md" alt="" />
                        ...
                        {wasClicked ?
                            <> 
                                ...
                                <div className="flex my-2">
                                    <Link to='/productos'> <button className="btn-secondary-detail mr-2"> Seguir comprando </button></Link> 
